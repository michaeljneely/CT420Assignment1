...
int main(int argc, char** argv) {
    ...
    // Main loop
    // Process full array and time each pass.. Use random no generator to access array randomly .. greater liklihood of paging in unlocked version
